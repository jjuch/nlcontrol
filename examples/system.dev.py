...
if mode is 'series':
    ...
    print(series_sys1.state_equation)
    print(series_sys1.output_equation)
    print(series_sys1, ' - ', series_sys1.system)

    series_sys2 = sys1.series(sys3)
    print(series_sys2.state_equation)
    print(series_sys2.output_equation)
    print(series_sys2, ' - ', series_sys2.system)

    sys2.block_configuration
    sys1.block_configuration
    series_sys3 = sys2.series(sys1)
    print(series_sys3.state_equation)
    print(series_sys3.output_equation)
    print(series_sys3, ' - ', series_sys3.system)

    series_sys4 = sys2.series(sys2)
    # print(series_sys4.state_equation)
    print(series_sys4.output_equation)
    print(series_sys4, ' - ', series_sys4.system)

    series_md = sys4.series(sys5)
    print(series_md.states)
    print(series_md.state_equation)
    print(series_md.output_equation)
    print(series_md, ' - ', series_md.system)

elif mode is 'parallel':
    parallel_sys1 = sys1.parallel(sys2)
    print(parallel_sys1.state_equation)
    print(parallel_sys1.output_equation)
    print(parallel_sys1, ' - ', parallel_sys1.system)

    parallel_sys2 = sys1.parallel(sys3)
    print(parallel_sys2.state_equation)
    print(parallel_sys2.output_equation)
    print(parallel_sys2, ' - ', parallel_sys2.system)

    parallel_sys3 = sys2.parallel(sys1)
    print(parallel_sys3.state_equation)
    print(parallel_sys3.output_equation)
    print(parallel_sys3, ' - ', parallel_sys3.system)

    parallel_sys4 = sys2.parallel(sys2)
    # print(parallel_sys4.state_equation)
    print(parallel_sys4.output_equation)
    print(parallel_sys4, ' - ', parallel_sys4.system)
